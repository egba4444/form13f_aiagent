...
def test_openapi_docs():
    ...
    print_response("GET /openapi.json", response)
...
def main():
    ...
    print("=" * 60)
    print("\n⚠️  These tests require ANTHROPIC_API_KEY in .env")
    print("   If not set, they will fail with LLM errors")
    print("\nContinue? (y/n): ", end="")
